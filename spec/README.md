...
This folder is the authoritative source for the **Technical Interview Mastery** content model, keyword taxonomy, and topic registry. It is **excluded from the published site** (via `_config.yml`'s `exclude:` list) — for contributors, agents, and automation only.
...
(PRE, L0–L6, META)           (5 mandatory + 4 conditional)          (Just the Docs / Jekyll)
```
