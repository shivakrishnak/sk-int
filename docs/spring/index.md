...
|----|---------|------------|------|--------|
| SPR-001 | Spring Framework Overview | ★☆☆ | 1 | complete |
| SPR-002 | Spring vs EJB - The Simplicity Revolution | ★☆☆ | 3 | complete |
| SPR-003 | Spring Ecosystem Map | ★☆☆ | 1 | complete |

### Spring - L1 Core Concepts.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-004 | Dependency Injection | ★☆☆ | 3 | complete |
| SPR-005 | Spring Bean | ★☆☆ | 1 | complete |
| SPR-006 | ApplicationContext | ★☆☆ | 1 | complete |

### Spring - L1 Spring Boot Basics.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-007 | Spring Boot Auto-configuration | ★☆☆ | 1 | complete |
| SPR-008 | @SpringBootApplication | ★☆☆ | 1 | complete |
| SPR-009 | Embedded Server | ★☆☆ | 1 | complete |

### Spring - L2 Bean Mechanics.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-010 | Bean Scopes | ★★☆ | 2 | complete |
| SPR-011 | Bean Lifecycle | ★★☆ | 2 | complete |

### Spring - L2 Injection and MVC.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-012 | @Autowired and Injection Types | ★★☆ | 2 | complete |
| SPR-013 | Spring MVC Request Lifecycle | ★★☆ | 2 | complete |

### Spring - L2 Data and Configuration.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-014 | Spring Data JPA Repository | ★★☆ | 2 | complete |
| SPR-015 | @ConfigurationProperties | ★★☆ | 2 | complete |

### Spring - L3 AOP and Transactions.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-016 | Spring AOP and Proxies | ★★☆ | 2 | complete |
| SPR-017 | @Transactional and Transaction Management | ★★☆ | 2 | complete |

### Spring - L3 Security and Observability.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-018 | Spring Security Filter Chain | ★★☆ | 3 | complete |
| SPR-019 | Spring Boot Actuator | ★★☆ | 3 | complete |

### Spring - L3 Profiles and Advanced Config.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-020 | Spring Profiles | ★★☆ | 3 | complete |
| SPR-021 | Conditional Beans and @ConditionalOnX | ★★☆ | 3 | complete |

### Spring - L4 Context Refresh Internals.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-022 | Spring Context Startup and Refresh | ★★★ | 4 | complete |

### Spring - L4 Bean Post-Processors.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-023 | BeanFactoryPostProcessor and BeanPostProcessor | ★★★ | 4 | complete |

### Spring - L4 OAuth2 and JWT Security.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-024 | Spring Security OAuth2 and JWT | ★★★ | 4 | complete |

### Spring - L4 Spring Boot Performance.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-025 | Spring Boot Startup Performance and Optimization | ★★★ | 4 | complete |

### Spring - L5 Microservices Architecture.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-026 | Spring Microservices with Spring Cloud | ★★★ | 4 | complete |

### Spring - L5 Cloud Configuration.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-027 | Spring Cloud Config and Service Discovery | ★★★ | 4 | complete |

### Spring - L6 Framework Internals.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-028 | Spring Framework Design Patterns | ★★☆ | 3 | complete |
| SPR-029 | Custom Spring Boot Starter Design | ★★☆ | 3 | complete |

### Spring - META Patterns.md

| ID | Keyword | Difficulty | Type | Status |
|----|---------|------------|------|--------|
| SPR-030 | IoC Container as Dependency Graph Mental Model | ★☆☆ | 1 | complete |
| SPR-031 | Convention Over Configuration Transfer | ★☆☆ | 1 | complete |
| SPR-032 | Proxy Pattern as Universal Spring Mechanism | ★☆☆ | 1 | complete |
