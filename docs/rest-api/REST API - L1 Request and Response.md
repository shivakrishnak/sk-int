...
#### Q2 - "How do you implement request correlation across microservices with headers?"
...
#### Q3 - "What security headers should every REST API response include?"
...
#### Q4 - "A client is complaining that their API calls work when they test with curl but fail in production. What header issues do you investigate?"
...
#### Q5 - "How do ETag headers work for REST API caching?"
...
#### Q6 - "How do rate limit headers work and what should clients do with them?"
...
#### Q7 - "What is the difference between X-Forwarded-For, X-Real-IP, and Forwarded headers?"
...
#### Q1 - "How does content negotiation support API versioning?"
...
#### Q2 - "How do you handle multipart/form-data vs application/json in a REST API?"
...
#### Q3 - "What is the difference between application/json and application/x-www-form-urlencoded?"
...
#### Q4 - "How do you design an API that needs to return both JSON and CSV?"
...
#### Q5 - "Why does content negotiation rarely work perfectly in practice?"
...
#### Q6 - "How does content type affect API security?"
...
#### Q7 - "How do you serialize dates in REST API JSON responses?"
...
#### Q1 - "What is the difference between stateless and stateful API design?"
...
#### Q2 - "How do you implement logout in a stateless JWT-based API?"
...
#### Q3 - "How does statelessness affect REST API performance?"
...
#### Q4 - "Can a stateless REST API support user-specific features like preferences or carts?"
...
#### Q5 - "What are the security risks of stateless JWT authentication?"
...
#### Q6 - "How does statelessness interact with API rate limiting?"
...
#### Q7 - "How do you design stateless APIs for multi-step workflows?"
