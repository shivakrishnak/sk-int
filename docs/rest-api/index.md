...
| # | Keyword | Status |
|---|---------|--------|
| 1 | What is REST | complete |
| 2 | The Six REST Constraints | complete |
| 3 | REST vs SOAP vs GraphQL - The API Ecosystem | complete |

### REST API - L1 Core Concepts.md (★☆☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | HTTP Methods in REST APIs | complete |
| 2 | HTTP Status Codes | complete |
| 3 | REST Resource Naming and URL Design | complete |

### REST API - L1 Request and Response.md (★☆☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | Request and Response Headers | complete |
| 2 | Content Negotiation and Media Types | complete |
| 3 | Stateless Communication | complete |

### REST API - L2 API Design.md (★★☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | API Versioning Strategies | complete |
| 2 | Pagination, Filtering, and Sorting | complete |

### REST API - L2 Security and CORS.md (★★☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | Authentication in REST APIs | complete |
| 2 | CORS and Cross-Origin Requests | complete |

### REST API - L3 Advanced Design.md (★★☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | HATEOAS and Hypermedia APIs | complete |
| 2 | Error Handling and Problem Details | complete |

### REST API - L3 Performance.md (★★☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | HTTP Caching for REST APIs | complete |
| 2 | Rate Limiting and Throttling Design | complete |

### REST API - L4 OAuth2 and JWT.md (★★★)

| # | Keyword | Status |
|---|---------|--------|
| 1 | OAuth2 and JWT Authentication Internals | complete |

### REST API - L4 Production Diagnostics.md (★★★)

| # | Keyword | Status |
|---|---------|--------|
| 1 | REST API Production Diagnostics | complete |

### REST API - L5 Architecture.md (★★★)

| # | Keyword | Status |
|---|---------|--------|
| 1 | API Gateway Architecture and Design | complete |

### REST API - L6 Theory.md (★★☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | Roy Fielding REST Architectural Style | complete |
| 2 | Richardson Maturity Model | complete |

### REST API - META Thinking Patterns.md (★☆☆)

| # | Keyword | Status |
|---|---------|--------|
| 1 | Resource-Oriented Thinking Mental Model | complete |
| 2 | Statelessness as a Scalability Principle | complete |
| 3 | API Contract First Design Mindset | complete |
