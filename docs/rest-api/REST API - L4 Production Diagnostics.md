...
> **Code walkthrough:** This DB slow queries (PostgreSQL) example demonstrates a key concept in practice using SQL. **KEY MECHANISM:** the runtime executes these instructions in sequence with specific memory and execution semantics. **WHY IT MATTERS:** misapplying this pattern causes subtle bugs that only manifest under production load. **TAKEAWAY: understand the execution model before using this pattern in production code.**
...
**[JUNIOR] Q1 - [DEBUGGING] "Walk me through diagnosing a sudden increase in 5xx error rates."**
...
**[JUNIOR] Q2 - [DEBUGGING] "How do you diagnose a latency spike affecting only some users?"**
...
**[JUNIOR] Q3 - [DEBUGGING] "Walk through diagnosing a database connection pool exhaustion issue."**
...
**[MID] Q4 - [DEBUGGING] "How do you use distributed tracing for microservices API diagnosis?"**
...
**[MID] Q5 - [DEBUGGING] "How do you diagnose a memory leak in a REST API service?"**
...
**[MID] Q6 - [PRODUCTION] "How do you monitor REST API SLOs and implement alert rules?"**
...
**[SENIOR] Q7 - [CONCEPTUAL] "Walk me through investigating an intermittent 500 error."**
...
**[SENIOR] Q8 - [DEBUGGING] "How do you diagnose slow REST API responses when the database shows fast query times?"**
...
**[SENIOR] Q9 - [PRODUCTION] "How do you implement a production runbook for a REST API incident?"**
...
**[STAFF] Q10 - [PRODUCTION] "How do you conduct a post-incident review for a REST API outage?"**
...
**[STAFF] Q11 - [PRODUCTION] "What metrics should every REST API expose and what should trigger alerts?"**
...
**[STAFF] Q12 - [DEBUGGING] "How do you handle production diagnostics when you can't reproduce the issue locally?"**
