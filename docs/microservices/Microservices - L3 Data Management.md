...
> **Code walkthrough:** This Database per Service example demonstrates a key concept in practice. **KEY MECHANISM:** the runtime executes these instructions in sequence with specific memory and execution semantics. **WHY IT MATTERS:** misapplying this pattern causes subtle bugs that only manifest under production load. **TAKEAWAY: understand the execution model before using this pattern in production code.**
...
**[JUNIOR] Q1 - [CONCEPTUAL] "A service needs data from two other services - how do you handle this without cross-service database joins?"**
...
**[JUNIOR] Q2 - [ARCHITECTURE] "How do you handle database migrations in a database-per-service architecture?"**
...
**[JUNIOR] Q3 - [ARCHITECTURE] "Design data architecture for an e-commerce platform with 10 services."**
...
**[MID] Q4 - [CONCEPTUAL] "What is the N+1 problem in microservices and how do you solve it?"**
...
**[MID] Q5 - [CONCEPTUAL] "How do you handle data ownership boundaries when business requirements span multiple services?"**
...
**[MID] Q6 - [HANDS-ON] "How do you implement data lineage and audit trails in database-per-service?"**
...
**[SENIOR] Q7 - [CONCEPTUAL] "A new requirement needs data from a service that currently exposes no API for it. What is your process?"**
...
**[SENIOR] Q8 - [CONCEPTUAL] "How does database per service interact with data consistency requirements?"**
...
**[SENIOR] Q9 - [ARCHITECTURE] "At scale with 200 services, how do you manage data governance?"**
...
**[JUNIOR] Q1 - [CONCEPTUAL] "What is the difference between choreography and orchestration sagas?"**
...
**[JUNIOR] Q2 - [ARCHITECTURE] "How do you design an idempotent compensating transaction?"**
...
**[JUNIOR] Q3 - [DEBUGGING] "A saga is stuck mid-execution. How do you diagnose and recover?"**
...
**[MID] Q4 - [ARCHITECTURE] "Design a saga for booking a flight + hotel + car rental package."**
...
**[MID] Q5 - [TRADE-OFF] "Compare saga pattern to 2PC (two-phase commit)."**
...
**[MID] Q6 - [HANDS-ON] "How do you test a saga implementation?"**
...
**[SENIOR] Q7 - [HANDS-ON] "What is the dual-write problem in sagas and how do you solve it?"**
...
**[SENIOR] Q8 - [ARCHITECTURE] "How does saga pattern scale at high transaction volume?"**
...
**[SENIOR] Q9 - [ARCHITECTURE] "Design compensation for a saga where a confirmation email was sent mid-saga."**
