...
#### Q1 - "Why is a big-bang monolith rewrite so often a failure?"
...
#### Q2 - "How do you select which capabilities to migrate first?"
...
#### Q3 - "Walk me through the strangler fig pattern step by step for a specific capability."
...
#### Q4 - "How do you handle the shared database problem during migration?"
...
#### Q5 - "How do you manage the team during a multi-year migration?"
...
#### Q6 - "What is the role of feature flags in a monolith migration?"
...
#### Q7 - "What are the most common reasons microservices migrations fail?"
...
#### Q8 - "How do you ensure data consistency during the migration period when both monolith and new service are running?"
...
#### Q9 - "What metrics do you track to know if a migration is going well?"
...
#### Q10 - "How do you handle the migration of cross-cutting concerns (authentication, logging, rate limiting)?"
...
#### Q11 - "How do you decide when NOT to migrate to microservices?"
...
#### Q12 - "How do you handle a migration that has stalled after 18 months with only 30% of capabilities migrated?"
