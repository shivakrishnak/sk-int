...
**[JUNIOR] Q1 - [CONCEPTUAL] "What is the difference between an API gateway and a load balancer?"**
...
**[JUNIOR] Q2 - [ARCHITECTURE] "What is the Backend-for-Frontend pattern and when should you use it?"**
...
**[JUNIOR] Q3 - [CONCEPTUAL] "How do you rate limit at the API gateway and what are the common algorithms?"**
...
**[MID] Q4 - [ARCHITECTURE] "Design an API gateway for a financial services company."**
...
**[MID] Q5 - [CONCEPTUAL] "What security responsibilities belong in the API gateway vs in the services?"**
...
**[MID] Q6 - [CONCEPTUAL] "How do you handle API versioning at the gateway level?"**
...
**[SENIOR] Q7 - [CONCEPTUAL] "What is the difference between a service mesh and an API gateway?"**
...
**[SENIOR] Q8 - [CONCEPTUAL] "How do you handle gateway security to prevent bypass?"**
...
**[SENIOR] Q9 - [ARCHITECTURE] "How does an API gateway scale to handle 100K requests per second?"**
...
> **Code walkthrough:** This Circuit Breaker Pattern example demonstrates exception handling. **KEY MECHANISM:** the JVM checks catch clauses in order; finally always executes for cleanup. **WHY IT MATTERS:** swallowing exceptions silently hides failures that corrupt downstream state. **TAKEAWAY: log or rethrow every exception; empty catch blocks are defects.**
...
**[JUNIOR] Q1 - [CONCEPTUAL] "What are the three states of a circuit breaker and what triggers each transition?"**
...
**[JUNIOR] Q2 - [ARCHITECTURE] "How do you design a fallback for a circuit breaker on a payment validation service?"**
...
**[JUNIOR] Q3 - [TRADE-OFF] "Compare circuit breaker, retry, and timeout patterns - when do you use each?"**
...
**[MID] Q4 - [CONCEPTUAL] "A circuit breaker is tripping every 5 minutes despite the downstream service appearing healthy. What do you investigate?"**
...
**[MID] Q5 - [PRODUCTION] "How do you monitor circuit breakers in production?"**
...
**[MID] Q6 - [ARCHITECTURE] "What is the relationship between circuit breaker and bulkhead patterns?"**
...
**[SENIOR] Q7 - [CONCEPTUAL] "How does circuit breaker behavior change at 1000 requests per second vs 10 per second?"**
...
**[SENIOR] Q8 - [DEBUGGING] "What is the half-open state and why is it necessary?"**
...
**[SENIOR] Q9 - [ARCHITECTURE] "Design circuit breaker configuration for a payment service with a 99.9% uptime requirement."**
