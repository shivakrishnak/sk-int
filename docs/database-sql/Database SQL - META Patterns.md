...
> **Code walkthrough:** The non-atomic pattern (BAD) has a crash window between
...
**Q1: How do you apply ACID reasoning to microservice architecture?**
...
**Q2: What is the TOCTOU problem and how do you prevent it?**
...
**Q3: What is the ACID interpretation of eventual consistency in distributed systems?**
...
**Q4: How do you use ACID reasoning to design idempotent APIs?**
...
**Q5: How does Git's data model demonstrate ACID properties?**
...
**Q6: What is the connection between ACID and the concepts of safe and liveness in distributed systems?**
...
**Q7: How do you apply the ACID lens to cache invalidation design?**
...
**Q1: Why is the 'index as cache' mental model useful for deciding when to add indexes?**
...
**Q2: What is a covering index and why is it the equivalent of a full cache hit?**
...
**Q3: How do you audit an application's index usage to find over-indexed or under-indexed tables?**
...
**Q4: How does the query planner decide between an index scan and a sequential scan?**
...
**Q5: What is partial index and how does it reduce the 'cache size' problem?**
...
**Q6: How does B-tree index height affect query performance?**
...
**Q7: When should you drop an index instead of adding a new one?**
...
> **Code walkthrough:** The N+1 anti-pattern: for each ID, run a query. This is
...
> **Code walkthrough:** The EXCEPT query is pure set difference - declared in one
...
**Q1: Explain the mental model shift from imperative to set-based thinking in SQL.**
...
**Q2: How does the NULL handling in SQL relate to set theory?**
...
**Q3: Explain the LATERAL join and what set operation it represents.**
...
**Q4: How do window functions extend the set model?**
...
**Q5: What is the correct mental model for understanding HAVING vs. WHERE?**
...
**Q6: How does EXISTS/NOT EXISTS relate to existential and universal quantification?**
