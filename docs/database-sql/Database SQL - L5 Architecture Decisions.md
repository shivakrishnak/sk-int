...
> **Code walkthrough:** CockroachDB uses the PostgreSQL wire protocol:
...
**Q1: When would you choose CockroachDB over PostgreSQL?**
...
**Q2: How do you decide when to move from PostgreSQL to a polyglot architecture?**
...
**Q3: What is the CAP theorem and how does it inform database architecture decisions?**
...
**Q4: How do you maintain consistency between PostgreSQL and Elasticsearch?**
...
**Q5: What is the CQRS pattern and when does it justify the added complexity?**
...
**Q6: How do you handle the dual-write problem when updating multiple databases?**
...
**Q7: What factors make Redis a poor choice for primary data storage?**
...
**Q8: When would you use a document database (MongoDB) over PostgreSQL?**
...
**Q9: How do you make a make-or-buy decision for a database vs. managed service?**
...
**Q10: How do you evaluate whether to adopt a NewSQL database (CockroachDB/Spanner)?**
...
**Q11: What is the database-per-service pattern in microservices and what problems does it cause?**
