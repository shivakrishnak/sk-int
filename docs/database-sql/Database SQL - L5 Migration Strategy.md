...
**Q1: What is the expand-contract pattern and why is it necessary for zero-downtime deployments?**
...
**Q2: Which ALTER TABLE operations are safe in production and which require special handling?**
...
**Q3: How do you handle a failed Flyway migration in production?**
...
**Q4: What is pg_repack and when would you use it?**
...
**Q5: How do you migrate a column to a new data type in a production database?**
...
**Q6: What is the role of feature flags in database migrations?**
...
**Q7: How do you validate data integrity after a migration?**
...
**Q8: How do you handle long-running migrations in a CI/CD pipeline?**
...
**Q9: What is the 'ghost row' technique and when is it used?**
...
**Q10: What monitoring is needed during a production migration?**
...
**Q11: How does zero-downtime deployment differ between PostgreSQL and MySQL for schema migrations?**
